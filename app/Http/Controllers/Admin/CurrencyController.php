...
class CurrencyController extends Controller
{
    ...
    {
        return $currencyDataTable->render('admin.settings.currencies.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.settings.currencies.create')->with("customFields", isset($html) ? $html : false);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.settings.currencies.show')->with('currency', $currency);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.settings.currencies.edit')->with('currency', $currency)->with("customFields", isset($html) ? $html : false);
    }
