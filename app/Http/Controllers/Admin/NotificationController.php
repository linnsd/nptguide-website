...
class NotificationController extends Controller
{
    ...
    public function create()
    {
        ...
        $notificationType = [];
        return view('admin.notifications.create')->with("customFields", isset($html) ? $html : false)->with("user", $user)->with("notificationType",$notificationType);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('admin.notifications.edit')->with('notification', $notification)->with("customFields", isset($html) ? $html : false)->with("user", $user);
    }
