...
class CategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.categories.create')->with("customFields", isset($html) ? $html : false)->with("parentCategory", $parentCategory);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.categories.edit')->with('category', $category)->with("customFields", isset($html) ? $html : false)->with("parentCategory", $parentCategory);
    }
