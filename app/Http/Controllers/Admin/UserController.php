...
class UserController extends Controller
{
    ...
    {
        return $userDataTable->render('admin.settings.users.index');
    }
    ...
    public function profile()
    {
        ...
        return view('admin.settings.users.profile', compact(['user', 'role', 'rolesSelected', 'customFields', 'customFieldsValues']));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.settings.users.profile')->with('user', $user);
    }
