...
class EServiceController extends Controller
{
    ...
    {
        return $eServiceDataTable->render('admin.e_services.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.e_services.create')->with("customFields", isset($html) ? $html : false)->with("category", $category)->with("categoriesSelected", $categoriesSelected)->with("eProvider", $eProvider);
    }
    ...
    public function show(int $id)
    {
        ...
        return view('admin.e_services.show')->with('eService', $eService);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('admin.e_services.edit')->with('eService', $eService)->with("customFields", isset($html) ? $html : false)->with("category", $category)->with("categoriesSelected", $categoriesSelected)->with("eProvider", $eProvider);
    }
