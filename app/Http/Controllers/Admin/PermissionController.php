...
class PermissionController extends Controller
{
    ...
    {
        return $permissionDataTable->render('admin.settings.permissions.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.settings.permissions.show')->with('permission', $permission);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.settings.permissions.edit')->with('permission', $permission);
    }
