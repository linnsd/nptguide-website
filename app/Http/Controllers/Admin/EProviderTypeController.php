...
class EProviderTypeController extends Controller
{
    ...
    {
        return $eProviderTypeDataTable->render('admin.e_provider_types.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.e_provider_types.create')->with("customFields", isset($html) ? $html : false);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.e_provider_types.show')->with('eProviderType', $eProviderType);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.e_provider_types.edit')->with('eProviderType', $eProviderType)->with("customFields", isset($html) ? $html : false);
    }
