...
class EProvider extends Model implements HasMedia, Castable
{
    ...
    public static $rules = [
        ...
        'tsh_id' => 'required|exists:townships,id',
        'address' => 'required|max:255',
        'latitude' => 'numeric|min:-200|max:200',
        'longitude' => 'numeric|min:-200|max:200',
    ];
    public $translatable = [
        // 'name',
        // 'description',
    ...
    {
        return $this->belongsTo(Township::class, 'tsh_id', 'id');
    }
    ...
    {
        return $this->hasMany(Promotion::class, 'place_id');
    }
