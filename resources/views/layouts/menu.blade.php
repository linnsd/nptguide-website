...
@can('requestedEProviders.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('requestedEProviders*') ? 'active' : '' }}" href="{!! route('requestedEProviders.index') !!}">
            @if ($icons)
...
@can('eProviders.index')
    <li
        class="nav-item has-treeview {{ (Request::is('eProvider*') || Request::is('galleries*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*')) && !Request::is('eProviderPayouts*') ? 'menu-open' : '' }}">
        <a href="#"
            class="nav-link {{ (Request::is('eProvider*') || Request::is('galleries*') || Request::is('experiences*') || Request::is('awards*') || Request::is('addresses*') || Request::is('availabilityHours*')) && !Request::is('eProviderPayouts*') ? 'active' : '' }}">
            @if ($icons)
        ...
        <ul class="nav nav-treeview">
            @can('eProviderTypes.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('eProviderTypes*') ? 'active' : '' }}" href="{!! route('eProviderTypes.index') !!}">
                        @if ($icons)
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('promotions*') ? 'active' : '' }}" href="{!! route('promotions.index') !!}">
                        @if ($icons)
                            <i class="nav-icon fas fa-list"></i>
                        @endif
                        <p>{{ trans('lang.promotion_table') }}</p>
                    </a>
                </li>
            @endcan
...
@can('rating.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('rating*') ? 'active' : '' }}" href="{!! route('rating.index') !!}">
            @if ($icons)
...
@can('townships.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('townships*') ? 'active' : '' }}" href="{!! route('townships.index') !!}">
            @if ($icons)
                <i class="nav-icon fas fa-city"></i>
            @endif
            <p>
                {{ trans('lang.township_plural') }}</p>
        </a>
    </li>
@endcan

@can('emergancy_contact.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('emergancy_contact*') ? 'active' : '' }}" href="{!! route('emergancy_contact.index') !!}">
            @if ($icons)
                <i class="nav-icon fas fa-phone-alt"></i>
            @endif
            <p>
                {{ trans('lang.emg_contact') }}</p>
        </a>
    </li>
@endcan

@can('ministry_contact.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('ministry_contact*') ? 'active' : '' }}" href="{!! route('ministry_contact.index') !!}">
            @if ($icons)
                <i class="nav-icon fas fa-phone-alt"></i>
            @endif
            <p>
                {{ trans('lang.ministry_contact') }}</p>
        </a>
    </li>
@endcan
...
@can('privacy_abouts.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('privacy_abouts*') ? 'active' : '' }}" href="{!! route('privacy_abouts.index') !!}">
            @if ($icons)
                <i class="nav-icon fas fa-question-circle"></i>
            @endif
            <p>
                {{ trans('lang.custom_page') }}</p>
        </a>
    </li>
@endcan

@can('text_slides.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('text_slides*') ? 'active' : '' }}" href="{!! route('text_slides.index') !!}">
            @if ($icons)
                <i class="nav-icon fas fa-font"></i>
            @endif
            <p>
                {{ trans('lang.slider_text') }}</p>
        </a>
    </li>
@endcan
...
@can('privacy_abouts.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('sms_contacts*') ? 'active' : '' }}" href="{!! route('sms_contacts.index') !!}">
            @if ($icons)
                <i class="fas fa-envelope-open-text"></i>
            @endif
            <p>
                {{ trans('lang.contact') }}</p>
        </a>
    </li>
@endcan
...
<!-- @can('privacy_policy.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('privacy_policy*') ? 'active' : '' }}" href="{!! route('privacy_policy.index') !!}">
            @if ($icons)
    <i class="nav-icon fas fa-question-circle"></i>
    @endif
            <p>
            {{ trans('lang.privacy_policies') }}</p></a>
                </li>
@endcan -->
...
{{-- @can('medias')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('medias*') ? 'active' : '' }}" href="{!! url('admin/medias') !!}">@if ($icons)
...
@can('app-settings')
    <li
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{!! url('admin/settings/mobile/globals') !!}"
                    class="nav-link {{ Request::is('admin/settings/mobile/globals*') ? 'active' : '' }}">
                    @if ($icons)
            ...
            <li class="nav-item">
                <a href="{!! url('admin/settings/mobile/colors') !!}"
                    class="nav-link {{ Request::is('admin/settings/mobile/colors*') ? 'active' : '' }}">
                    @if ($icons)
    ...
    <li
        class="nav-item has-treeview {{ (Request::is('settings*') || Request::is('users*')) && !Request::is('admin/settings/mobile*')
            ? 'menu-open'
            : '' }}">
        <a href="#"
            class="nav-link {{ (Request::is('admin/settings*') || Request::is('users*')) && !Request::is('admin/settings/mobile*')
                ? 'active'
                : '' }}">
            @if ($icons)
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{!! url('admin/settings/app/globals') !!}"
                    class="nav-link {{ Request::is('admin/settings/app/globals*') ? 'active' : '' }}">
                    @if ($icons)
                        <i class="nav-icon fas fa-cog"></i>
                    @endif
            ...
            <li
                class="nav-item has-treeview {{ Request::is('admin/settings/permissions*') || Request::is('admin/settings/roles*') ? 'menu-open' : '' }}">
                <a href="#"
                    class="nav-link {{ Request::is('admin/settings/permissions*') || Request::is('admin/settings/roles*') ? 'active' : '' }}">
                    @if ($icons)
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('admin/settings/permissions/create') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('admin/settings/roles') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('admin/settings/roles/create') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/settings/customFields*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a href="{!! url('admin/settings/app/localisation') !!}"
                    class="nav-link {{ Request::is('admin/settings/app/localisation*') ? 'active' : '' }}">
                    @if ($icons)
            ...
            <li class="nav-item">
                <a href="{!! url('admin/settings/translation/en') !!}"
                    class="nav-link {{ Request::is('admin/settings/translation*') ? 'active' : '' }}">
                    @if ($icons)
                        <i class="nav-icon fas fa-language"></i>
                    @endif
            ...
            @can('currencies.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/settings/currencies*') ? 'active' : '' }}"
            ...
            @can('taxes.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/settings/taxes*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a href="{!! url('admin/settings/payment/payment') !!}"
            ...
            <li class="nav-item">
                <a href="{!! url('admin/settings/app/social') !!}"
                    class="nav-link {{ Request::is('admin/settings/app/social*') ? 'active' : '' }}">
                    @if ($icons)
            ...
            <li class="nav-item">
                <a href="{!! url('admin/settings/app/notifications') !!}"
                    class="nav-link {{ Request::is('admin/settings/app/notifications*') ? 'active' : '' }}">
                    @if ($icons)
                        <i class="nav-icon fas fa-bell"></i>
                    @endif
            ...
            <li class="nav-item">
                <a href="{!! url('admin/settings/mail/smtp') !!}"
                    class="nav-link {{ Request::is('admin/settings/mail*') ? 'active' : '' }}">
                    @if ($icons)
