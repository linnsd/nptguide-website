                    ...
                    <div class="col-lg-8">
                        <div class="place__left">
                            <ul class="place__breadcrumbs breadcrumbs">
                                <li><a title="Pyinmana" href="#">Pyinmana</a></li>
                           ...
                           {{--  @if(isset($amenities))
                            ...
                            <div class="place__box place__box-map">
                                ...
                                <div class="maps">
                                    ...
                                    <input type="hidden" id="place_lat" value="19.353453">
                                    <input type="hidden" id="place_lng" value="96.353252">
                                    <input type="hidden" id="place_icon_marker" value="">
                                </div>
                                <div class="address">
                                    <i class="la la-map-marker"></i>
                                    place address
                                    <a href="https://maps.google.com/?q=linnit" title="Direction" target="_blank" rel="nofollow">({{__('Direction')}})</a>
                                </div>
                            </div><!-- .place__box -->
                            <div class="place__box">
                                ...
                                <ul class="place__contact">
                                        <li>
                                            ...
                                            <a href="tel:'0923525235'" rel="nofollow">09325235235</a>
                                        </li>
